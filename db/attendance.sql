...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.1&nocache=4202367623ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="252">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=attendance&table=professor&lang=en">`attendance`.`professor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=attendance&table=students&lang=en">`attendance`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud&table=info&lang=en">`crud`.`info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_ams&table=students&lang=en">`db_ams`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud1&table=info&lang=en">`crud1`.`info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud&table=data&lang=en">`crud`.`data`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud1&table=data&lang=en">`crud1`.`data`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud&table=name&lang=en">`crud`.`name`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="3334372c23452a535557755f3540394c">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="252"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
