                    ...
                    <div class="bg-white p-5 mx-3 md:my-5 lg:my-5" style="max-width: 500px">
                        ...
                        <form action="./controller.php?action=add" method="post" class="space-y-4 text-xs md:text-base lg:text-base" enctype="multipart/form-data">
                            <div class="space-y-2">
                                ...
                                <input type="text" value="" autocomplete="off" name="studentName" class="text-sm bg-gray-100 focus:outline-none border-none focus:bg-gray-200 rounded py-2 px-2 text-gray-500 w-full">
                            </div>
                            
                            <div class="space-y-2">
                                <p class="text-sm">Student ID<span class="text-red-500">*</span></p>
                                <input type="text" value="" autocomplete="off" name="studentId" class="text-sm bg-gray-100 focus:outline-none border-none focus:bg-gray-200 rounded py-2 px-2 text-gray-500 w-full">
                            </div>
                            ...
                            <div class="flex justify-center">
                                <div style="font-size: 14px" class="pt-6">
                                    ...
                                    <button class="relative px-6 bg-yellow-400 hover:bg-yellow-300 py-2 text-white rounded ml-3" name="add" type="submit" onclick="this.classList.toggle('button--loading')">
