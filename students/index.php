...
<head>
  ...
  <title>Atendace Monitoring System</title>
</head>
<body>
  <div class="container mx-auto">
    ...
    <div class="flex justify-center flex-col items-center h-screen space-y-3">
      <div class="p-4">
        <img src="../images/students.svg" alt="" style="width: 534px">
      </div>
      <div class="text-center">
        <div class="flex items-center">
          <h1 style="font-size: 50px">Hi, Good day Student</h1>
          <img src="../images/wave.gif" alt="" style="width: 80px">
        </div>
