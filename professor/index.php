        ...
        <div  class="flex justify-around gap-9">
            ...
            <form action="./attendancetable/profprocess.php" method="POST">
                <div class="flex flex-col space-y-3 w-96">
                    ...
                    <input type="time" class="border-2 border-opacity-50 border-gray-400 rounded p-3 focus:border-yellow-500 focus:outline-none w-full" placeholder="type the exact time to end the class" name="timeOut">
